...
export const getAssetData = async (ticker: string): Promise<AssetData> => {
    ...
    const pricesSelector = "//section[@data-testid='quote-price']/div/section//*/span"
    ...
    return { data: [], id: { ticker, url, name }, info: { realtimePrice, realtimePriceChange, realtimePriceChangePercent } }
